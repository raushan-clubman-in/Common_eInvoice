...
Imports System.IO
Public Class rptReciprocalSaleRegister
    ...
    Public Function Reportdetails(ByVal SQLSTRING As String, ByVal PAGEHEAD() As String, ByVal FROMDATE As Date, ByVal TODATE As Date)
        ...
        Try
            ...
            gconnection.getDataSet(SQLSTRING, "RECIPROCALSALEREGISTER")
            If gdataset.Tables("RECIPROCALSALEREGISTER").Rows.Count > 0 Then
                Filewrite.WriteLine()
                pagesize = pagesize + 1
                For Each dr In gdataset.Tables("RECIPROCALSALEREGISTER").Rows
                    If pagesize > 58 Then
                        ...
                        pagesize = pagesize + 1
                    End If
                    If DateValue(varBilldate) <> DateValue(dr("BILLDATE")) Then
                        If Billdatebool = True Then
                            ...
                            Filewrite.WriteLine(StrDup(135, "."))
                            pagesize = pagesize + 1
                            varBilldate = DateValue(dr("BILLDATE"))
                    ...
                    Filewrite.Write("{0,-18}", Mid(Trim(CStr(dr("BILLDETAILS"))), 1, 15))
