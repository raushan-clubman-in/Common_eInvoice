...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.PictureBox2.Location = New System.Drawing.Point(328, 368)
        ...
        Me.PictureBox1.Location = New System.Drawing.Point(136, 368)
...
#End Region
    ...
    Private Sub Cmd_Login_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Login.Click
        ...
        Try
            ...
            '           SQLSTRING = "SELECT * FROM USERADMIN WHERE  USERNAME = '" & Trim(UCase(Txt_Username.Text)) & "' and USERPASSWORD ='" & Trim(GetPassword(UCase(Txt_Password.Text))) & "' AND MAINGROUP = 'POS' AND CATEGORY  = 'U'"
            '          Else
    ...
    Public Sub GetServer()
        ...
        Try
            ...
            ServerConn.Open()
            Dim sqlstring As String
            ssql = "SELECT SERVER,TALLYODBC,TALLYPORT,TALLYDSN,TallyIntegration,TallyKotFlag,TallyFBillFlag,TallyDBillFlag,TallyBatchFlag,TallyCompanyName,TallyServer,TallyUser,SqlUserName,SqlUserPassword,RoundOffFlag,ClosingBalanceFlag,ProductKey,TallyBulkUpdateFBill,TallyBulkUpdateKot,KOTWITHBILL FROM DBSKEY"
            ...
            If getserver.Tables(0).Rows.Count > 0 Then
                ...
                gTallyCompanyName = Trim(getserver.Tables(0).Rows(0).Item(9) & "")
                gTallyServer = Trim(getserver.Tables(0).Rows(0).Item(10) & "")
                gTallyUser = Trim(getserver.Tables(0).Rows(0).Item(11) & "")
                gSqlUserName = Trim(getserver.Tables(0).Rows(0).Item(12) & "")
                ...
                gClosingBalanceFlag = Trim(getserver.Tables(0).Rows(0).Item(15) & "")
