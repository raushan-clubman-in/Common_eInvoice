...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'fgrdCompanyList
        '
        Me.fgrdCompanyList.Location = New System.Drawing.Point(64, 160)
...
#Region "Upgrade Support "
    ...
    Public Shared Property DefInstance() As CompanyList1
        ...
        End Get
        Set(ByVal Value As CompanyList1)
...
#End Region
    ...
    Private Sub fgrdCompanyList_Click1()
        ...
        If Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 0)) <> "" Then
            ...
            vCompanyname = Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 0))
            gShortName = Trim(fgrdCompanyList.get_TextMatrix(fgrdCompanyList.Row, 8))
            ...
            'If gCompanyname = "MADRAS CRICKET CLUB" Or gCompanyname = "TEST" Then
            '    ' DO NOTHING
            'Else
            '    End
            'End If
        ...
        If gdataset.Tables("CLUBMASTER").Rows.Count > 0 Then
            ...
            For LoopIndex = 0 To gdataset.Tables("CLUBMASTER").Rows.Count - 1
                With gdataset.Tables("CLUBMASTER").Rows(LoopIndex)
                    ...
                    fgrdCompanyList.set_TextMatrix(LoopIndex + 1, 8, Trim(CStr(.Item("SHORTNAME"))))
    ...
    Private Sub ImgQuit1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ImgQuit1.Click

    End Sub

    Private Sub CompanyList1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
