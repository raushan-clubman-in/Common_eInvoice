...
Public Class frmVoucherControl
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmVoucherControl))
        ...
        Me.Chklist_poslocation.Location = New System.Drawing.Point(296, 120)
        Me.Chklist_poslocation.Name = "Chklist_poslocation"
        Me.Chklist_poslocation.Size = New System.Drawing.Size(408, 424)
        Me.Chklist_poslocation.TabIndex = 407
        '
        'CmdClear
        '
        ...
        Me.grp_SalebillChecklist.TabIndex = 403
        ...
        Me.Label3.Text = "SALE REGISTER [ VOUCHER CONTROL ]"
        '
        'Chk_poslocation
        '
        ...
        Me.Chk_poslocation.Location = New System.Drawing.Point(296, 72)
        Me.Chk_poslocation.Name = "Chk_poslocation"
        Me.Chk_poslocation.Size = New System.Drawing.Size(144, 24)
        Me.Chk_poslocation.TabIndex = 411
        ...
        Me.Label5.Location = New System.Drawing.Point(144, 687)
        ...
        Me.Label4.Location = New System.Drawing.Point(296, 96)
        ...
        Me.KeyPreview = True
        Me.Name = "frmVoucherControl"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "SALE REGISTER [ VOUCHER CONTROL ]"
...
#End Region
    ...
    Private Sub frmVoucherControl_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub CmdView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdView.Click
        Try
            ...
            grp_SalebillChecklist.Left = 144
    ...
    Private Sub CmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdPrint.Click
        ...
        End Try
    End Sub
    Private Sub Viewvouchercontrolsalesregister()
        Dim i As Integer
        Try
            Dim sqlstring = "SELECT POSDESC,SUM(ISNULL(BASICAMOUNT,0)) AS BASICAMOUNT,SUM(ISNULL(TAXAMOUNT,0)) AS TAXAMOUNT,SUM(ISNULL(NETAMOUNT,0)) AS NETAMOUNT FROM VIEWVOUCHERCONTROL"
            ...
            'SHAN
            'SELECT POSDESC,SUM(BASICAMOUNT,0) AS BASICAMOUNT,BASIC(TAXAMOUNT,0) AS TAXAMOUNT,SUM(NETAMOUNT,0) AS NETAMOUNT

            Dim pageheading() As String = {"FINAL BILL CONTROL REGISTER"}
            Dim objVoucherwiseSaleRegisterReport As New rptVoucherwiseSaleRegisterReport
            objVoucherwiseSaleRegisterReport.ReportDetails(sqlstring, pageheading, mskFromDate.Value, mskToDate.Value)
        Catch ex As Exception
    ...
    Private Sub Timer1_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        Try
            ...
            Else
                ...
                Call Viewvouchercontrolsalesregister()
            End If
        Catch ex As Exception
            MessageBox.Show("Check The Error " & ex.Message, MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
            Exit Sub
    ...
    Private Sub frmVoucherControl_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
            Dim i As Integer
