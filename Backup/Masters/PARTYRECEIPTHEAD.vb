...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(PARTYRECEIPTHEAD))
        ...
        Me.ssgrid1.Size = New System.Drawing.Size(592, 432)
        ...
        Me.Name = "PARTYRECEIPTHEAD"
        Me.Text = "PARTYRECEIPTHEAD"
...
#End Region
    ...
    Private Sub PARTYRECEIPTHEAD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select A.Receiptheadcode,A.Receiptheaddesc ,isnull(a.LEDGERNAME,'') as LedgerName  FROM PARTY_HEAD_MASTER a   order by a.Receiptheadcode "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    .Row = j
                    .Col = 1
                    .Text = gdataset.Tables("acctag").Rows(i).Item("Receiptheadcode")
                    .Col = 2
                    .Text = gdataset.Tables("acctag").Rows(i).Item("Receiptheaddesc")
                    .Col = 3
    ...
    Private Sub FillMenu()
        ...
        Dim ssql As String
        gSQLString = "select  LEDGERNAME from PARTY_HEAD_MASTER "
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.PARTYRECEIPTHEAD_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update PARTY_HEAD_MASTER set LEDGERNAME='" & acccd & "' where Receiptheadcode='" & itemcd & "'"
    ...
    Private Sub Cmd_Audit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Audit.Click
        Try
            ...
            _export.TABLENAME = "PARTY_HEAD_MASTER"
