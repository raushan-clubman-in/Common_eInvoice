...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(VENDORLEDGER))
...
#End Region
    ...
    Private Sub VENDORLEDGER_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.SLCODE,a.SLDESC ,isnull(a.VENDORTYPE,'') as LedgerName,ISNULL(GSTINNO,'')AS GSTINNO  from ACCOUNTSSUBLEDGERMASTER a  WHERE ACCODE IN(SELECT ISNULL(SCRSCODE,'') FROM ACCOUNTSSETUP)AND ISNULL(FREEZEFLAG,'')<>'Y'  order by a.SLCODE "
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            ...
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                VoucherType = .Text
                If VoucherType <> "" Then
                    ssql = "update ACCOUNTSSUBLEDGERMASTER set VENDORTYPE='" & acccd & "',GSTINNO='" & VoucherType & "' where SLCODE='" & itemcd & "'"
                    Vconn.dataOperation(6, ssql, "item")
                End If
            Next
