Public Class TOURNAMENTTAGGING
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(TOURNAMENTTAGGING))
        ...
        Me.Label1.Text = "CHARGECODE TAGGING"
        '
        'TOURNAMENTTAGGING
        '
...
#End Region
    ...
    Private Sub TOURNAMENTTAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.CHARGECODE,a.CHARGEDESC ,isnull(a.TYPEOFTAX,'') as LedgerName,isnull(a.SACNO,'') as costcenter  from CHARGEMASTER a   order by a.CHARGEDESC "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    .Row = j
                    .Col = 1
                    .Text = gdataset.Tables("acctag").Rows(i).Item("CHARGECODE")
                    .Col = 2
                    .Text = gdataset.Tables("acctag").Rows(i).Item("CHARGEDESC")
                    .Col = 3
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.TOURNAMENTTAGGING_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update CHARGEMASTER set TYPEOFTAX='" & acccd & "',SACNO='" & cc & "' where CHARGECODE='" & itemcd & "'"
