Public Class VENDORLEDGERmember
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(VENDORLEDGERmember))
        ...
        Me.Panel1.Location = New System.Drawing.Point(720, 168)
        Me.Panel1.Name = "Panel1"
        Me.Panel1.Size = New System.Drawing.Size(132, 280)
        ...
        Me.ssgrid1.Size = New System.Drawing.Size(512, 376)
        ...
        Me.Label1.Text = "ACCOUNTS MEMBER LEDGER "
        '
        'Label2
        '
        ...
        Me.ClientSize = New System.Drawing.Size(880, 593)
        Me.Controls.Add(Me.Label2)
        Me.Controls.Add(Me.Label1)
        Me.Controls.Add(Me.Panel1)
        Me.Controls.Add(Me.ssgrid1)
        Me.Cursor = System.Windows.Forms.Cursors.Default
        Me.Name = "VENDORLEDGERmember"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent
        Me.Text = "VENDORLEDGER"
...
#End Region
    ...
    Private Sub VENDORLEDGERmember_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        If Mid(UCase(MyCompanyName), 1, 7) = "THE SAT" Then
            SQLSTRING = "select a.SLCODE,a.SLDESC ,isnull(B.CURENTSTATUS,'') as LedgerName,ISNULL(B.HSN,'')AS GSTINNO  from ACCOUNTSSUBLEDGERMASTER a ,MEMBERMASTER B WHERE A.SLCODE=B.MCODE AND  ACCODE IN(SELECT ISNULL(SDRSCODE,'') FROM ACCOUNTSSETUP) order by a.SLCODE "
        Else
            SQLSTRING = "select a.SLCODE,a.SLDESC ,isnull(B.CURENTSTATUS,'') as LedgerName,ISNULL(B.GSTINNO,'')AS GSTINNO  from ACCOUNTSSUBLEDGERMASTER a ,MEMBERMASTER B WHERE A.SLCODE=B.MCODE AND  ACCODE IN(SELECT ISNULL(SDRSCODE,'') FROM ACCOUNTSSETUP) order by a.SLCODE "
        End If
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    ...
                    .Col = 4
                    .Text = gdataset.Tables("acctag").Rows(i).Item("GSTINNO")
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.VENDORLEDGERmember_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        End If
        With ssgrid1
            ssql = "alter table accountssubledgermaster disable trigger all"
            ...
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                VoucherType = .Text
                If VoucherType <> "" Then
                    ssql = "update ACCOUNTSSUBLEDGERMASTER set GSTINNO='" & VoucherType & "' where SLCODE='" & itemcd & "' AND SLTYPE='member'"
                    Vconn.dataOperation(6, ssql, "item")
                    ssql = "update MEMBERMASTER set GSTINNO='" & VoucherType & "' where MCODE='" & itemcd & "' "
                    Vconn.dataOperation(6, ssql, "item")
                    If Mid(UCase(MyCompanyName), 1, 7) = "THE SAT" Then
                        ssql = "update MEMBERMASTER set HSN='" & VoucherType & "' where MCODE='" & itemcd & "' "
                        Vconn.dataOperation(6, ssql, "item")
                    End If
                End If
            Next
            ssql = "alter table accountssubledgermaster enable trigger all"
            Vconn.dataOperation(6, ssql, "item")
        End With
