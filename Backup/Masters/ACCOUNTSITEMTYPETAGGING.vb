Public Class ACCOUNTSITEMTYPETAGGING
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ACCOUNTSITEMTYPETAGGING))
        ...
        Me.ssgrid1.Location = New System.Drawing.Point(64, 88)
        ...
        Me.cmd_exit.Location = New System.Drawing.Point(464, 8)
        ...
        Me.Name = "ACCOUNTSITEMTYPETAGGING"
        Me.Text = "ACCOUNTSITEMTYPETAGGING"
...
#End Region
    ...
    Private Sub ACCOUNTSITEMTYPETAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.taxcode as ItemTypecode,a.taxdesc +'--@'+cast(taxpercentage as varchar(20)) as ItemTypeDesc,isnull(a.LEDGERNAME,'') as LedgerName  from accountstaxmaster a  order by a.taxcode "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    .Row = j
                    .Col = 1
                    .Text = gdataset.Tables("acctag").Rows(i).Item("ItemTypecode")
                    .Col = 2
                    .Text = gdataset.Tables("acctag").Rows(i).Item("ItemTypeDesc")
                    .Col = 3
    ...
    Private Sub FillMenu()
        ...
        Dim ssql As String
        gSQLString = "select  isnull(LEDGERNAME,'') as ledgername from ItemTypeMaster "
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                .Col = 3
                acccd = .Text
                ssql = "update itemtypemaster set LEDGERNAME='" & acccd & "' where taxcode='" & itemcd & "'"
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call ACCOUNTSITEMTYPETAGGING_Load(sender, e)
    End Sub
    ...
    Private Sub Cmd_Audit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Audit.Click
        Try
            ...
            sqlstring = "drop view vw_tally_ItemTypeMaster"
            Vconn.getDataSet(sqlstring, "acctag")

            sqlstring = "create view vw_tally_ItemTypeMaster as select * from ItemTypeMaster"
            Vconn.getDataSet(sqlstring, "acctag")

            _export.TABLENAME = "vw_tally_ItemTypeMaster"
            sqlstring = "SELECT * FROM vw_tally_ItemTypeMaster"
