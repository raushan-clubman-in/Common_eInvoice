Public Class TOURNAMENTTAGGINGTOUR
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(TOURNAMENTTAGGINGTOUR))
        ...
        Me.Label1.Text = "GOLF TOURNAMENT TAGGING"
        '
        'TOURNAMENTTAGGINGTOUR
        '
        ...
        Me.Name = "TOURNAMENTTAGGINGTOUR"
        Me.Text = "TOURNAMENTTAGGING"
...
#End Region
    ...
    Private Sub TOURNAMENTTAGGINGTOUR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.TOURNAMENTCODE,a.TOURNAMENTNAME ,isnull(a.TAXTYPE,'') as LedgerName,isnull(a.SACNO,'') as costcenter  from GMS_TOURNAMENTMASTER a   order by a.TOURNAMENTCODE "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    .Row = j
                    .Col = 1
                    .Text = gdataset.Tables("acctag").Rows(i).Item("TOURNAMENTCODE")
                    .Col = 2
                    .Text = gdataset.Tables("acctag").Rows(i).Item("TOURNAMENTNAME")
                    .Col = 3
    ...
    Private Sub FillMenu()
        ...
        Dim ssql As String
        gSQLString = "select  LEDGERNAME from GMS_TOURNAMENTMASTER "
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.TOURNAMENTTAGGINGTOUR_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update GMS_TOURNAMENTMASTER set TAXTYPE='" & acccd & "',SACNO='" & cc & "' where TOURNAMENTCODE='" & itemcd & "'"
