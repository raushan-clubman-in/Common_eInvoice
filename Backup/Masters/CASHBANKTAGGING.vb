...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(CASHBANKTAGGING))
        ...
        Me.Name = "CASHBANKTAGGING"
        Me.Text = "CASHBANKTAGGING"
...
#End Region
    ...
    Private Sub CASHBANKTAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "SELECT A.ACCODE,A.ACDESC,ISNULL(A.LEDGERNAME,'')AS LEDGERNAME,ISNULL(A.costcenter,'')AS costcenter FROM ACCOUNTSGLACCOUNTMASTER a   order by a.ACCODE "
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.CASHBANKTAGGING_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update ACCOUNTSGLACCOUNTMASTER set LEDGERNAME='" & acccd & "',costcenter='" & cc & "' where ACCODE='" & itemcd & "'"
