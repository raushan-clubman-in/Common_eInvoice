Public Class ACCOUNTSEVENTTAGGING
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ACCOUNTSEVENTTAGGING))
        ...
        Me.Label1.Text = "EVENT MASTER TAGGING"
        '
        'ACCOUNTSEVENTTAGGING
        '
        ...
        Me.Name = "ACCOUNTSEVENTTAGGING"
        Me.Text = "ACCOUNTSEVENTTAGGING"
...
#End Region
    Private Sub ACCOUNTSEVENTTAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.EVENTCODE,a.EVENTNAME ,isnull(a.TAXTYPE,'') as Ledger ,ISNULL(A.SACNO,'')AS COSTCENTER from EV_EVENTS_HDR a  order by a.EVENTCODE "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    .Row = j
                    .Col = 1
                    .Text = gdataset.Tables("acctag").Rows(i).Item("EVENTCODE")
                    .Col = 2
                    .Text = gdataset.Tables("acctag").Rows(i).Item("EVENTCODE")
                    .Col = 3
    ...
    Private Sub FillMenuCOST()
        ...
        Dim ssql As String
        gSQLString = "select  isnull(COSTCENTER,'') as COSTCENTER from EV_EVENTS_HDR "
    ...
    Private Sub FillMenu()
        Dim vform As New ListOperattion1
        Dim ssql As String
        gSQLString = "select  isnull(LEDGER,'') as ledger from EV_EVENTS_HDR "
        vform.Field = "LEDGER"
        vform.vFormatstring = "LEDGER"
        vform.vCaption = "LEDGER NAME HELP"
        vform.KeyPos = 0
        vform.KeyPos1 = 0
        vform.ShowDialog(Me)
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                .Col = 4
                COSTCD = .Text
                ssql = "update EV_EVENTS_HDR set TAXTYPE='" & acccd & "' ,SACNO= '" & COSTCD & "'where EVENTCODE='" & itemcd & "'"
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call ACCOUNTSEVENTTAGGING_Load(sender, e)
    End Sub
    ...
    Private Sub Cmd_Audit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Audit.Click
        Try
            ...
            sqlstring = "create view vw_tally_Subscriptionmast as select * from EV_EVENTS_HDR"
            Vconn.getDataSet(sqlstring, "acctag")
