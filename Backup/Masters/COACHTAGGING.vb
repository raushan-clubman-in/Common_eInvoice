...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(COACHTAGGING))
        ...
        Me.Name = "COACHTAGGING"
        Me.Text = "COACHTAGGING"
...
#End Region
    ...
    Private Sub COACHTAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.COACHCODE,a.COACHNAME ,isnull(a.LEDGERNAME,'') as LedgerName,isnull(a.costcenter,'') as costcenter  from GMS_COACHMASTER a   order by a.COACHCODE "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    .Row = j
                    .Col = 1
                    .Text = gdataset.Tables("acctag").Rows(i).Item("COACHCODE")
                    .Col = 2
                    .Text = gdataset.Tables("acctag").Rows(i).Item("COACHNAME")
                    .Col = 3
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.COACHTAGGING_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update GMS_COACHMASTER set LEDGERNAME='" & acccd & "',costcenter='" & cc & "' where COACHCODE='" & itemcd & "'"
