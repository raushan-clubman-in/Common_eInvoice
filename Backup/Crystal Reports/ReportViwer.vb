...
Public Class ReportViwer
    ...
    Public vconn As New GlobalClass
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.CrystalReportViewer1.Size = New System.Drawing.Size(1032, 704)
    ...
    Public Function GetDetails(ByVal sqlstring As String, ByVal Tabname As String, ByVal rpt As Object)
        Try
            If sqlstring <> "" Then
                ...
                adp.Fill(ds, Tabname)
                vconn.getDataSet(sqlstring, Tabname)
                If ds.Tables(Tabname).Rows.Count > 0 Then
                    rpt.SetDataSource(ds.Tables(Tabname))
                    CrystalReportViewer1.ReportSource = rpt
                    CrystalReportViewer1.Zoom(100)
                Else
                    MsgBox("Data Not Found...", MsgBoxStyle.Information, "DATA NOT AVAILABLE")
                    Me.Close()
                    Exit Function
                End If
        ...
        Catch ex As Exception
            MsgBox(ex.Message, MessageBoxButtons.OK, MessageBoxIcon.Information)
        End Try
    End Function
