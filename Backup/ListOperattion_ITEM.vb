Option Explicit On 
Public Class ListOperattion_ITEM
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ListOperattion_ITEM))
...
#End Region
    ...
    Private Sub txtSearch_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSearch.TextChanged
        ...
        If CbxColumn.Text <> "" Then
            ...
            ssql = ssql & " (I.ITEMCODE LIKE '%" & Trim(txtSearch.Text) & "%' OR I.ITEMDESC LIKE '%" & Trim(txtSearch.Text) & "%')"
        ...
        If ssql <> "" Then
            ...
            Else
                If Mid(gTallyIntegration, 1, 1) = "Y" And Mid(gTallyFBillFlag, 1, 1) = "Y" Then
                    ...
                    'tally member INSERTION
                    ssql = "Select $Name,$ClosingBalance from '" & gTallyCompanyName & "'.'" & gTallyUser & "'.'Ledger' where $$IsBelongsTo:$$GroupSundryDebtors and ($Name='" & Trim(txtSearch.Text) & "' OR $Name='" & Trim(txtSearch.Text) & "')"
                    vfill.Open(ssql, myconnection)
                    If Not vfill.EOF Then
                        'INSERT FROM TALLY TO SMARAT CARD
                        MsgBox("Item is availbale in Tally Kindly Create", MsgBoxStyle.OKOnly, "Item")
                    Else
