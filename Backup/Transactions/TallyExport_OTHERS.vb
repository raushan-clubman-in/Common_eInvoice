...
Imports System.IO
Imports System.Math
Public Class TallyExport_OTHERS
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(TallyExport_OTHERS))
        ...
        Me.lbl_heading.Size = New System.Drawing.Size(337, 28)
        Me.lbl_heading.TabIndex = 5
        Me.lbl_heading.Text = "Accounts Tally - Export - OTHERS"
        '
        'Cmd_Posted
        '
        ...
        Me.lbl_head.Text = "PARTY BILL POSTING"
        ...
        Me.Tallypostingssgrid.Size = New System.Drawing.Size(952, 432)
        ...
        Me.GrpPeriod.Size = New System.Drawing.Size(616, 56)
        ...
        Me.ComboBox2.Items.AddRange(New Object() {"Sales", "Receipt"})
        Me.ComboBox2.Location = New System.Drawing.Point(880, 64)
        ...
        Me.Label2.Location = New System.Drawing.Point(632, 64)
        ...
        Me.ComboBox1.Items.AddRange(New Object() {"SMART CARD", "PARTY", "GUEST REGISTRATION", "CARSTICKER", "GUEST ROOM", "MEMBER", "EVENTS", "LIBRARY", "INVENTORY", "GOLF", "MEMBER APPLICATION"})
        Me.ComboBox1.Location = New System.Drawing.Point(712, 64)
        ...
        Me.GrdAuditTrail.Location = New System.Drawing.Point(32, 112)
        ...
        Me.GrdAuditTrail.Size = New System.Drawing.Size(944, 432)
        ...
        Me.txt_vouchertype.Text = "SalesParty"
        '
        'TallyExport_OTHERS
        '
        ...
        Me.KeyPreview = True
        Me.Name = "TallyExport_OTHERS"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Accounts Tally - Export - Party Bill"
...
#End Region
    ...
    Private Sub TallyExport_OTHERS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub Cmd_Cancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Cancel.Click
        ...
        End Try
    End Sub
    Private Sub TallyExport_OTHERS_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
    ...
    Private Sub TallyExport_OTHERS_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        Try
    ...
    Private Sub FillTallypostingdetails()
        Try
            ...
            SQLSTRING = "select * into TMP_MONTHBILL from VIEW_OTHERS_BILL A WHERE A.VOUCHERDATE BETWEEN '" & Format(dtp_Fromdate.Value, "dd/MMM/yyyy") & "' AND '" & Format(dtp_Todate.Value, "dd/MMM/yyyy") & "' AND MODULE='" & ComboBox1.Text & "'"
            gconnection.getDataSet(SQLSTRING, "TALLYMST")
    ...
    Private Function TallyExport_OTHERS()
        ...
        Try
            ...
            sqlstring = "select * into TMP_MONTHBILL from VIEW_OTHERS_BILL A WHERE A.VOUCHERDATE BETWEEN '" & Format(dtp_Fromdate.Value, "dd/MMM/yyyy") & "' AND '" & Format(dtp_Todate.Value, "dd/MMM/yyyy") & "'AND MODULE='" & ComboBox1.Text & "'AND MODULE='" & ComboBox1.Text & "' AND MODULE='" & ComboBox1.Text & "'"
            gconnection.getDataSet(sqlstring, "TALLYMST")
    ...
    Private Sub chks()
        ...
        Try
            ...
            Dim strRequestXML, strRequestXML2, voucherno, deb, pos As String
                ...
                For rowi = 0 To gdataset.Tables("acc").Rows.Count - 1
                    With gdataset.Tables("acc").Rows(rowi)
                        ...
                        If voucherno <> .Item("voucherno") Then
                            ...
                            strRequestXML = strRequestXML & "<REQUESTDATA>"
                            strRequestXML = strRequestXML & "<TALLYMESSAGE>"
                            strRequestXML = strRequestXML & "<VOUCHER VCHTYPE='Members Receipts' ACTION='Create'>"       ' for create /
                            ' update / delete
                            strRequestXML = strRequestXML & "<DATE>" & Format(CDate(gdataset.Tables("acc").Rows(rowi).Item("voucherdate")), "yyyyMMdd") & "</DATE>" ' kotdate
                            strRequestXML = strRequestXML & "<NARRATION>" & Trim(gdataset.Tables("acc").Rows(rowi).Item("instrumentno")) & "</NARRATION>"
                            strRequestXML = strRequestXML & "<VOUCHERTYPENAME>Members Receipts</VOUCHERTYPENAME>"
                        ...
                        strRequestXML = strRequestXML & "<ISDEEMEDPOSITIVE>" & pos & "</ISDEEMEDPOSITIVE>"
                        ...
                        End If
                        strRequestXML = strRequestXML & "<BILLALLOCATIONS.LIST>"
                        'strRequestXML = strRequestXML & "<NAME>Member Receipt</NAME>"
                        'strRequestXML = strRequestXML & "<BILLCREDITPERIOD>45 Days</BILLCREDITPERIOD>"
                        'strRequestXML = strRequestXML & "<BILLTYPE>New Ref</BILLTYPE>"
                        ''strRequestXML = strRequestXML & "<AMOUNT>-" & Trim(gdataset.Tables("KOTHDR_AMT").Rows(0).Item("BILLAMT")) & "</AMOUNT>"    'net amount
                        ''strRequestXML = strRequestXML & "<AMOUNT>-" & Trim(gdataset.Tables("acc").Rows(rowi).Item("AMOUNT")) & "</AMOUNT>"
    ...
    Private Sub txt_vouchertype_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_vouchertype.TextChanged
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        If ComboBox1.Text = "SMART CARD" Then
            Me.ComboBox2.Text = "Receipt"
        End If
        If ComboBox1.Text = "PARTY" Then
            Me.ComboBox2.Text = "Sales"
        End If
        If ComboBox1.Text = "GUEST REGISTRATION" Then
            Me.ComboBox2.Text = "Receipt"
        End If
        If ComboBox1.Text = "CARSTICKER" Then
            Me.ComboBox2.Text = "Sales"
        End If
        If ComboBox1.Text = "GUEST ROOM" Then
            Me.ComboBox2.Text = "Receipt"
        End If
        If ComboBox1.Text = "MEMBER" Then
            Me.ComboBox2.Text = "Receipt"
        End If
        If ComboBox1.Text = "EVENTS" Then
            Me.ComboBox2.Text = "Sales"
        End If
        If ComboBox1.Text = "LIBRARY" Then
            Me.ComboBox2.Text = "Sales"
        End If
        If ComboBox1.Text = "INVENTORY" Then
            Me.ComboBox2.Text = "Sales"
        End If
        If ComboBox1.Text = "GOLF" Then
            Me.ComboBox2.Text = "Receipt"
        End If
        If ComboBox1.Text = "MEMBER APPLICATION" Then
            Me.ComboBox2.Text = "Receipt"
        End If
