...
Imports System.IO
Imports System.Math
Public Class TallyExport_Party
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(TallyExport_Party))
        ...
        Me.lbl_heading.Text = "Accounts Tally - Export - Party Bill"
        '
        'Cmd_Posted
        '
...
#End Region
    ...
    Private Sub TallyExport_Party_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub Cmd_Cancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Cancel.Click
        ...
        End Try
    End Sub
    Private Sub TallyExport_Party_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
    ...
    Private Sub TallyExport_Party_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        Try
    ...
    Private Sub FillTallypostingdetails()
        Try
            ...
            SQLSTRING = "select * into TMP_MONTHBILL from VIEW_PARTY_BILL A WHERE A.VOUCHERDATE BETWEEN '" & Format(dtp_Fromdate.Value, "dd/MMM/yyyy") & "' AND '" & Format(dtp_Todate.Value, "dd/MMM/yyyy") & "'"
            gconnection.getDataSet(SQLSTRING, "TALLYMST")
    ...
    Private Function tallyvoucherImport()
        ...
        End Try
    End Function
    Private Function TallyExport_Party()
        Dim myconnection As New ADODB.Connection
        Dim ssql As String
        Dim sval1 As Double
        Try
