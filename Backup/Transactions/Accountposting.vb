...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Accountposting))
        ...
        Me.Accountpostingssgrid.Location = New System.Drawing.Point(8, 80)
        ...
        Me.Accountpostingssgrid.Size = New System.Drawing.Size(1008, 440)
        ...
        Me.Grp_AccountPosting.Location = New System.Drawing.Point(8, 0)
        Me.Grp_AccountPosting.Name = "Grp_AccountPosting"
        Me.Grp_AccountPosting.Size = New System.Drawing.Size(1016, 680)
        ...
        Me.GrdAuditTrail.Size = New System.Drawing.Size(987, 496)
...
#End Region
    ...
    Private Sub Cmd_Posted_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Posted.Click
        ...
        For K = 0 To 1
            If K = 0 Then
                'Posted Accounts
                SQLSTRING = "EXEC Cp_AccountsPostingView_Credit " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'T'"
                strAccHead = "Posted Accounts"
            Else
                'Accounts to be Posted
                SQLSTRING = "EXEC Cp_AccountsPostingView_Credit " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'P'"
                strAccHead = "Accounts to be Posted"
            End If
            gconnection.dataOperation(6, SQLSTRING, "ACCOUNTPOSTING")
            SQLSTRING = "EXEC Cp_PosJv_Credit '" & Mid(Trim(gFinancalyearStart), 3, 4) & "','" & Mid(Trim(gFinancialYearEnd), 3, 4) & "','" & Trim(gUsername) & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'T'"
            gconnection.dataOperation(6, SQLSTRING, "ACCOUNTPOSTING")
            'End
            ' Adjusting for Add Arrear and Less Onaccount For CBIL

            SQLSTRING = "EXEC Sp_OnAccountMatching '" & Format(DateValue(strFinancialYearStart), "dd/MMM/yyyy") & "','" & Format(DateValue(dtp_Todate.Value), "dd/MMM/yyyy") & "'"
                            ...
                            If gdataset.Tables("SLCODE").Rows.Count > 0 Then
                                For J = 0 To gdataset.Tables("SLCODE").Rows.Count - 1
                                    ...
                                    If Trim(gdataset.Tables("SLCODE").Rows(J).Item("sldesc")) <> "" Then
                                        ...
                                        'Changes For Upto Selected Date opcredit and opdebit
                                        ' Begin Date: 25082008
                                        ' By Frank
                                        SQLSTRING = "SELECT ISNULL(SLCODE,'') AS SLCODE, ISNULL(SLDESC,'') SLDESC,ISNULL("
                                        SQLSTRING = SQLSTRING & Mid(Format(CDate(dtp_Todate.Value), "dd/MMM/yyyy"), 4, 3) & "DEBITS,0) AS CLDEBITS, ISNULL("
                                        SQLSTRING = SQLSTRING & Mid(Format(CDate(dtp_Todate.Value), "dd/MMM/yyyy"), 4, 3) & "CREDITS,0) AS CLCREDITS FROM ACCOUNTSSUBLEDGERMASTER WHERE ACCODE = '" & Trim(gdataset.Tables("ACCODE").Rows(I).Item("Accountcode")) & "' AND ISNULL(FREEZEFLAG,'')<>'Y' and Slcode='" & Trim(gdataset.Tables("SLCODE").Rows(J).Item("SLCODE")) & "' "
                                        'End
                                    ...
                                    Else
                                        ...
                                        ' Begin Date: 25082008
                                        ' By Frank
                                        SQLSTRING = "Select Isnull(Accode,'') as Accode, Isnull(Acdesc,'') as Acdesc,Isnull("
                                        SQLSTRING = SQLSTRING & Mid(Format(CDate(dtp_Todate.Value), "dd/MMM/yyyy"), 4, 3) & "DEBITS,0) As CLDEBITS, Isnull("
                                        SQLSTRING = SQLSTRING & Mid(Format(CDate(dtp_Todate.Value), "dd/MMM/yyyy"), 4, 3) & "CREDITS,0) As CLCREDITS  from AccountsGlAccountMaster  where isnull(Freezeflag,'') <> 'Y' AND ACCODE='" & Trim(gdataset.Tables("ACCODE").Rows(I).Item("ACCOUNTCODE")) & "'"
                                        'End
    ...
    Private Sub Cmd_Cancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Cancel.Click
        grp_Billposting.Top = 1000
        Accountpostingssgrid.SendToBack()
        Cmd_View.Focus()
    End Sub
    ...
    Private Sub Fillaccountpostingdetails()
        ...
        Try
            ...
            For j = 0 To 1
                If j = 0 Then
                    strsql = "Exec Cp_AccountsPostingView_Credit " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'T'"
                    strPostHead = "Posted Accounts"
                Else
                    strsql = "Exec Cp_AccountsPostingView_Credit " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'P'"
    ...
    Private Sub cmdPost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPost.Click
        ...
        Try
            ...
            strsql = "EXEC Cp_PosJv_Credit '" & Mid(Trim(gFinancalyearStart), 3, 4) & "','" & Mid(Trim(gFinancialYearEnd), 3, 4) & "','" & Trim(gUsername) & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'P'"
            'End
            gconnection.dataOperation(6, strsql, "ACCOUNTPOSTING")
