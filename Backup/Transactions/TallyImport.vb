...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(TallyImport))
        ...
        Me.lbl_heading.Size = New System.Drawing.Size(383, 28)
        Me.lbl_heading.TabIndex = 5
        Me.lbl_heading.Text = "Import From Tally - Members Vouchers"
        '
        'Cmd_Posted
        '
        ...
        Me.GrpPeriod.Controls.Add(Me.Cmd_Confirm)
        ...
        'Cmd_Confirm
        '
        Me.Cmd_Confirm.BackColor = System.Drawing.Color.ForestGreen
        Me.Cmd_Confirm.FlatStyle = System.Windows.Forms.FlatStyle.Popup
        Me.Cmd_Confirm.Font = New System.Drawing.Font("Times New Roman", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.Cmd_Confirm.ForeColor = System.Drawing.Color.White
        Me.Cmd_Confirm.Image = CType(resources.GetObject("Cmd_Confirm.Image"), System.Drawing.Image)
        Me.Cmd_Confirm.Location = New System.Drawing.Point(320, 16)
        Me.Cmd_Confirm.Name = "Cmd_Confirm"
        Me.Cmd_Confirm.Size = New System.Drawing.Size(96, 32)
        Me.Cmd_Confirm.TabIndex = 171
        Me.Cmd_Confirm.Text = "Previous Data"
        '
        'Cmd_Dump
        '
        ...
        Me.Cmd_Dump.Location = New System.Drawing.Point(184, 16)
        ...
        'Chk_Reset
        '
        Me.Chk_Reset.Location = New System.Drawing.Point(456, 552)
        Me.Chk_Reset.Name = "Chk_Reset"
        Me.Chk_Reset.Size = New System.Drawing.Size(64, 24)
        Me.Chk_Reset.TabIndex = 173
        ...
        Me.Label3.Location = New System.Drawing.Point(445, 48)
        ...
        Me.Text = "Import From Tally - Members Vouchers"
...
#End Region
    ...
    Private Sub TallyImport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub Cmd_Cancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Cancel.Click
        ...
        End Try
    End Sub
    Private Sub TallyImport_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
    ...
    Private Sub TallyImport_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        Try
            ...
            If gdataset.Tables("ACCODE").Rows.Count > 0 Then
                For I = 0 To gdataset.Tables("ACCODE").Rows.Count - 1
                    With Tallypostingssgrid
                        ...
                        SQLSTRING = SQLSTRING & " FROM Tally_Journalentry_tmp where creditdebit='CREDIT' AND isnull(void,'')='Y' and CONVERT(CHAR(39),voucherDATE,106) = '" & Format(gdataset.Tables("ACCODE").Rows(I).Item("VOUCHERDATE"), "dd MMM yyyy") & "' GROUP BY VOUCHERNO,VOUCHERDATE,SLCODE,SLDESC,vouchertype,void ORDER BY VoucherDate,Void,Vouchertype,slcode"
                        gconnection.getDataSet(SQLSTRING, "SLCODE")
                        If gdataset.Tables("SLCODE").Rows.Count > 0 Then
                            .Row = ROWCOUNT
                            .Col = 2
                        ...
                        SQLSTRING = "SELECT isnull(void,'') as void,isnull(vouchertype,'') as vouchertype,ISNULL(SUM(ISNULL(AMOUNT,0)),0) AS AMOUNT,ISNULL(VOUCHERNO,'') AS VOUCHERNO,ISNULL(VOUCHERDATE,'') AS VOUCHERDATE,ISNULL(SLCODE,'') AS SLCODE,ISNULL(SLDESC,'') AS SLDESC"
                        SQLSTRING = SQLSTRING & " FROM Tally_Journalentry_tmp where creditdebit='CREDIT' AND isnull(void,'')='N' and CONVERT(CHAR(39),voucherDATE,106) = '" & Format(gdataset.Tables("ACCODE").Rows(I).Item("VOUCHERDATE"), "dd MMM yyyy") & "' GROUP BY VOUCHERNO,VOUCHERDATE,SLCODE,SLDESC,vouchertype,void ORDER BY VoucherDate,Void,Vouchertype,slcode"
                        gconnection.getDataSet(SQLSTRING, "SLCODE")
                        If gdataset.Tables("SLCODE").Rows.Count > 0 Then
                            .Row = ROWCOUNT
                            .Col = 2
    ...
    Private Function tallyvoucherImport()
        Try
            ...
            SQLSTRING = "INSERT INTO Tally_JOURNALENTRY_Verify (VoucherNo,voucherdate,VoucherCategory,VoucherType,CashBank,SLCODE,SLDESC,CreditDebit,Amount,Description,InstrumentDate,InstrumentType,Instrumentno,BankName,BankPlace) (select VoucherNo,voucherdate,VoucherCategory,VoucherType,CashBank,SLCODE,SLDESC,CreditDebit,Amount,Description,InstrumentDate,InstrumentType,Instrumentno,BankName,BankPlace from Tally_JournalEntry_Tmp where isnull(void,'')='N' and voucherdate <= (select max(billdate) from subsposting) and void<>'Y')"
            gconnection.getDataSet(SQLSTRING, "ACCODE")

            SQLSTRING = "Update Tally_Journalentry_tmp set void='Y' where voucherdate <= (select max(billdate) from subsposting) and void<>'Y'"
            gconnection.getDataSet(SQLSTRING, "ACCODE")

            If Chk_Reset.Checked = True Then
                SQLSTRING = "Delete from JOURNALENTRY where voucherdate between '" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "' and '" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "' and voucherdate > (select max(billdate) from subsposting)"
                gconnection.getDataSet(SQLSTRING, "ACCODE")

                SQLSTRING = "update Tally_JournalEntry_Tmp set void='N' where voucherdate between '" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "' and '" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "' and voucherdate > (select max(billdate) from subsposting)"
                gconnection.getDataSet(SQLSTRING, "ACCODE")
            End If
    ...
    Private Sub Cmd_Confirm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Confirm.Click
        Try
            Dim sqlstring As String
            Dim _export As New EXPORT
            _export.TABLENAME = "Tally_JOURNALENTRY_Verify"
            sqlstring = "SELECT * FROM Tally_JOURNALENTRY_Verify"
            Call _export.export_excel(sqlstring)
            _export.Show()
            Exit Sub
        Catch ex As Exception
