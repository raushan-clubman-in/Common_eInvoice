...
Public Class Accountposting_Party
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Accountposting_Party))
...
#End Region
    ...
    Private Sub Cmd_Posted_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Posted.Click
        ...
        For K = 0 To 1
            If K = 0 Then
                'Posted Accounts
                SQLSTRING = "EXEC Cp_AccountsPostingView_Party " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'T'"
                strAccHead = "Posted Accounts"
            Else
                'Accounts to be Posted
                SQLSTRING = "EXEC Cp_AccountsPostingView_Party " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'P'"
                strAccHead = "Accounts to be Posted"
            End If
            gconnection.dataOperation(6, SQLSTRING, "ACCOUNTPOSTING")
            SQLSTRING = "EXEC Cp_PosJv_Party '" & Mid(Trim(gFinancalyearStart), 3, 4) & "','" & Mid(Trim(gFinancialYearEnd), 3, 4) & "','" & Trim(gUsername) & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'T'"
            gconnection.dataOperation(6, SQLSTRING, "ACCOUNTPOSTING")
            'End
    ...
    Private Sub Fillaccountpostingdetails()
        ...
        Try
            ...
            For j = 0 To 1
                If j = 0 Then
                    strsql = "Exec Cp_AccountsPostingView_Party " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'T'"
                    strPostHead = "Posted Accounts"
                Else
                    strsql = "Exec Cp_AccountsPostingView_Party " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'P'"
    ...
    Private Sub cmdPost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPost.Click
        ...
        Try
            ...
            strsql = "EXEC Cp_PosJv_Party '" & Mid(Trim(gFinancalyearStart), 3, 4) & "','" & Mid(Trim(gFinancialYearEnd), 3, 4) & "','" & Trim(gUsername) & "','" & Format(Now, "dd-MMM-yyyy") & "', 'P'"
            'End
            gconnection.dataOperation(6, strsql, "ACCOUNTPOSTING")
