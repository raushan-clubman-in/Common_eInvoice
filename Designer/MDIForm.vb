...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'MainMenu1
        '
        Me.MainMenu1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem1, Me.MenuItem10, Me.MenuItem72, Me.mnu_Administrator, Me.MenuItem66, Me.mnu_Exit, Me.MenuItem12})
        '
        'MenuItem1
        '
        ...
        Me.MenuItem72.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem83, Me.MenuItem84, Me.MenuItem85, Me.MenuItem86, Me.MenuItem87, Me.MenuItem73, Me.MenuItem74, Me.MenuItem75, Me.MenuItem76, Me.MenuItem77, Me.MenuItem78, Me.MenuItem79, Me.MenuItem80, Me.MenuItem81, Me.MenuItem82, Me.MenuItem88, Me.MenuItem89, Me.MenuItem91})
        Me.MenuItem72.Text = "E_invoice"
        '
        'MenuItem83
        '
        Me.MenuItem83.Index = 0
        Me.MenuItem83.Text = "Subscription Bills"
        '
        'MenuItem84
        '
        Me.MenuItem84.Index = 1
        Me.MenuItem84.Text = "Debit Note"
        '
        'MenuItem85
        '
        Me.MenuItem85.Index = 2
        Me.MenuItem85.Text = "Credit Note"
        '
        'MenuItem86
        '
        Me.MenuItem86.Index = 3
        Me.MenuItem86.Text = "Invoice"
        '
        'MenuItem87
        '
        Me.MenuItem87.Index = 4
        Me.MenuItem87.Text = "Entrance Fee Receipt"
        '
        'MenuItem73
        '
        Me.MenuItem73.Index = 5
        Me.MenuItem73.Text = "Pos_Bills"
        '
        'MenuItem74
        '
        Me.MenuItem74.Index = 6
        Me.MenuItem74.Text = "Green Fee"
        '
        'MenuItem75
        '
        Me.MenuItem75.Index = 7
        Me.MenuItem75.Text = "Driving Range Fee"
        '
        'MenuItem76
        '
        Me.MenuItem76.Index = 8
        Me.MenuItem76.Text = "Coaching"
        '
        'MenuItem77
        '
        Me.MenuItem77.Index = 9
        Me.MenuItem77.Text = "Ball Sale"
        '
        'MenuItem78
        '
        Me.MenuItem78.Index = 10
        Me.MenuItem78.Text = "Hiring Golf"
        '
        'MenuItem79
        '
        Me.MenuItem79.Index = 11
        Me.MenuItem79.Text = "Hiring Driving"
        '
        'MenuItem80
        '
        Me.MenuItem80.Index = 12
        Me.MenuItem80.Text = "Camp Fee"
        '
        'MenuItem81
        '
        Me.MenuItem81.Index = 13
        Me.MenuItem81.Text = "Cart Issue"
        '
        'MenuItem82
        '
        Me.MenuItem82.Index = 14
        Me.MenuItem82.Text = "Short Game"
        '
        'MenuItem88
        '
        Me.MenuItem88.Index = 15
        Me.MenuItem88.Text = "Party Bill"
        '
        'MenuItem89
        '
        Me.MenuItem89.Index = 16
        Me.MenuItem89.Text = "Room Bill"
        '
        'mnu_Administrator
        '
        Me.mnu_Administrator.Index = 3
        ...
        Me.MenuItem66.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem67, Me.MenuItem58, Me.MenuItem90})
        ...
        Me.MenuItem90.Text = "eInvoice Report"
        '
        'mnu_Exit
        '
        Me.mnu_Exit.Index = 5
        ...
        'MenuItem91
        '
        Me.MenuItem91.Index = 17
        Me.MenuItem91.Text = "Guest Entry"
        '
        'MDIForm
        '
...
#End Region
    ...
    Private Sub Activateuseradmin()
        ...
        For i = 0 To MainMenu1.MenuItems.Count - 2
            ...
            End If
        Next
        gconnection.getDataSet("SELECT COUNT(*) FROM  modulemaster WHERE PackageName='EINVOICE'", "chk")
        If gdataset.Tables("chk").Rows.Count <> totmenu Then
            gconnection.ExcuteStoreProcedure("DELETE FROM modulemaster WHERE PackageName='EINVOICE'")
            Call checkmenulist()
        End If
    ...
    Sub relemenu_old()
        ...
        Dim chstr As String
        gconnection.getDataSet("SELECT * FROM USERADMIN WHERE USERNAME = '" & Trim(gUsername) & "' AND MAINGROUP='EINVOICE'", "user")
            ...
            For i = 0 To gdataset.Tables("user").Rows.Count - 1
                With gdataset.Tables("user").Rows(i)
                    If Trim(.Item("mainmoduleid") & "") <> "" And Trim(.Item("submoduleid") & "") <> "" And Trim(.Item("ssubmoduleid") & "") <> "" Then
                        ...
                        MainMenu1.MenuItems(.Item("mainmoduleid")).MenuItems(.Item("submoduleid")).MenuItems(.Item("ssubmoduleid")).Enabled = True
                    ...
                    ElseIf Trim(.Item("mainmoduleid") & "") <> "" And Trim(.Item("submoduleid") & "") <> "" Then
                        ...
                        MainMenu1.MenuItems(.Item("mainmoduleid")).MenuItems(.Item("submoduleid")).Enabled = True
                        chstr = abcdMINUS(.Item("rights"))
                    ElseIf Trim(.Item("mainmoduleid") & "") <> "" Then
                        'MainMenu1.MenuItems(Val(.Item("mainmoduleid"))).Enabled = True
                        MainMenu1.MenuItems(.Item("mainmoduleid")).Enabled = True
                        chstr = abcdMINUS(.Item("rights"))
                    End If
                End With
            Next
                    ...
                    For j = 0 To vsmod - 1
                        ...
                        If vssmod <> 0 Then
                            For k = 0 To vssmod - 1
                                ...
                                vsql(vsql.Length - 1) = vsql(vsql.Length - 1) & "'" & k & "','" & Trim(MainMenu1.MenuItems(i).MenuItems(j).MenuItems(k).Text.Replace("&", "") & "") & "','EINVOICE')"
                        ...
                        Else
                            ...
                            vsql(vsql.Length - 1) = vsql(vsql.Length - 1) & " ('" & i & "','" & Trim(MainMenu1.MenuItems(i).Text.Replace("&", "") & "") & "',"
                            vsql(vsql.Length - 1) = vsql(vsql.Length - 1) & "'" & j & "','" & Trim(MainMenu1.MenuItems(i).MenuItems(j).Text.Replace("&", "") & "") & "',"
                            vsql(vsql.Length - 1) = vsql(vsql.Length - 1) & "'','','EINVOICE')"
                            ReDim Preserve vsql(vsql.Length)
                        End If
                    Next
                Else
    ...
    Private Sub MenuItem73_Click_1(sender As Object, e As EventArgs) Handles MenuItem73.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Pos_Bills"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "POSBILL"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub

    Private Sub MenuItem74_Click_1(sender As Object, e As EventArgs) Handles MenuItem74.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Green Fee"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "GOLF COURSE"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem75_Click(sender As Object, e As EventArgs) Handles MenuItem75.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Driving Range Fee"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "DRIVING RANGE"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem76_Click(sender As Object, e As EventArgs) Handles MenuItem76.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Coaching"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "COACHING"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem77_Click(sender As Object, e As EventArgs) Handles MenuItem77.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Ball Sale"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "BALLSALE"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem78_Click(sender As Object, e As EventArgs) Handles MenuItem78.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Hiring Golf"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "HIRINGGOLF"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem79_Click(sender As Object, e As EventArgs) Handles MenuItem79.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Hiring Driving"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "HIRINGDRIVING"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem80_Click(sender As Object, e As EventArgs) Handles MenuItem80.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Camp Fee"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "CAMPFEE"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem81_Click(sender As Object, e As EventArgs) Handles MenuItem81.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Cart Issue"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "CARTISSUE"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem82_Click(sender As Object, e As EventArgs) Handles MenuItem82.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Short Game"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "SHORT"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem83_Click(sender As Object, e As EventArgs) Handles MenuItem83.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Subscription Bills"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "SUBSCRIPTION"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem84_Click(sender As Object, e As EventArgs) Handles MenuItem84.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Debit Note"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "DEBITNOTE"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem85_Click(sender As Object, e As EventArgs) Handles MenuItem85.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Credit Note"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "CREDITNOTE"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem86_Click(sender As Object, e As EventArgs) Handles MenuItem86.Click
        ...
        GmoduleName = "Invoice"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "INVOICE"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem87_Click(sender As Object, e As EventArgs) Handles MenuItem87.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Entrance Fee Reciept"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "ENTFEE"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem88_Click(sender As Object, e As EventArgs) Handles MenuItem88.Click
        ...
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "PARTY"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem89_Click(sender As Object, e As EventArgs) Handles MenuItem89.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Room Bill"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "ROOM"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub

    Private Sub MenuItem90_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub MenuItem90_Click_1(sender As Object, e As EventArgs) Handles MenuItem90.Click
        Dim Objaccountposting As New eInvoiceDetails
        GmoduleName = "eInvoice Report"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
    ...
    Private Sub MenuItem91_Click(sender As Object, e As EventArgs) Handles MenuItem91.Click
        Dim Objaccountposting As New E_invoicing
        GmoduleName = "Guest Entry"
        Objaccountposting.FormBorderStyle = FormBorderStyle.FixedDialog
        Objaccountposting.OPERATION_TYPE.Text = "GUESTENTRY"
        Objaccountposting.MdiParent = Me
        Objaccountposting.Show()
    End Sub
End Class