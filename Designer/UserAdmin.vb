...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.OptFP.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.OptDU.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.OptCR.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.OptCP.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.OptCU.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.lbl_confirm.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.lstUsers.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.Lbl_Forget.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
...
#End Region
    ...
    Private Sub GetRights()
        ...
        Sqlstring = Sqlstring & " WHERE USERNAME = '" & Trim(UserName) & "' AND ISNULL(M.PACKAGENAME,'') ='ACCOUNTS INTEGRATION' "
    ...
    Private Sub FillModules()
        ...
        Sqlstring = Sqlstring & "ISNULL(SUBMODULENAME,'') AS SUBMODULENAME,ISNULL(SSUBMODULEID,'') AS SSUBMODULEID,ISNULL(SSUBMODULENAME,'') AS SSUBMODULENAME  FROM MODULEMASTER WHERE PACKAGENAME = 'ACCOUNTS INTEGRATION' ORDER BY MAINMODULEID,MAINMODULENAME"
            ...
            For Loopindex = 0 To gdataset.Tables("USER").Rows.Count - 1
                With gdataset.Tables("USER").Rows(Loopindex)
                    ...
                    If vSsub <> Trim(.Item("SsubModuleID") & "") Then
                        ...
                        vMain = Trim(.Item("mainModuleId") & "")
                        Sqlstring = "SELECT ISNULL(ROWID,0) AS ROWID,ISNULL(MAINMODULEID,'') AS MAINMODULEID,ISNULL(MAINMODULENAME,'') AS MAINMODULENAME,ISNULL(SUBMODULEID,'') AS SUBMODULEID,"
                        Sqlstring = Sqlstring & "ISNULL(SUBMODULENAME,'') AS SUBMODULENAME,ISNULL(SSUBMODULEID,'') AS SSUBMODULEID,ISNULL(SSUBMODULENAME,'') AS SSUBMODULENAME  FROM MODULEMASTER WHERE PACKAGENAME = 'ACCOUNTS INTEGRATION' AND MAINMODULEID ='" & Trim(vMain) & "' AND SUBMODULEID ='" & Trim(vSub) & "' ORDER BY MAINMODULEID,MAINMODULENAME"
        ...
        Try
            ...
            If Me.OptDU.Checked = True Then
                ...
                If Trim(Me.txtusername.Text) <> "" Then
                    qry(0) = "Delete From Master..UserAdmin  where UserName='" & Trim(Me.txtusername.Text) & "' And MainGroup='ACCOUNTS INTEGRATION' "
                    qry(1) = "Delete From UserAdmin  where UserName='" & Trim(Me.txtusername.Text) & "' And MainGroup='ACCOUNTS INTEGRATION' "
                    gconnection.MoreTransold(qry)
                Else
    ...
    Public Sub Addoperation()
        ...
        If OptCU.Checked = True Or Me.OptCR.Checked = True Then
                    ...
                    If Trim(vDesc & "") <> "" Then
                        ...
                        If gdataset.Tables("MODULE").Rows.Count > 0 Then
                            ...
                            With gdataset.Tables("MODULE").Rows(0)
                                ...
                                " Values('" & Trim(vUserName) & "','" & Trim(vUserPassword) & "','U','" & Trim(.Item("MainModuleId") & "") & "','" & Trim(.Item("SubModuleid") & "") & "','" & Trim(.Item("SsubModuleid") & "") & "','" & Trim(abcdADD(vDesc) & "") & "','" & Trim(Mname) & "','ACCOUNTS INTEGRATION')"
                                aryindex = aryindex + 1
                            End With
                        End If
                    End If
            ...
            qry(qry.Length - 1) = "INSERT INTO MASTER..USERADMIN(UserName,UserPassword,Category,MainGroup) " & _
             " values('" & Trim(vUserName) & "','" & Trim(vUserPassword) & "','U','ACCOUNTS INTEGRATION')"
            If Me.OptCU.Checked = True Then
                gconnection.MoreTransold(qry)
            ElseIf Me.OptCR.Checked = True Then
                Dim str(qry.Length + 1) As String
                str(0) = "DELETE FROM MASTER..USERADMIN WHERE  UserName='" & Trim(Me.txtusername.Text) & "' AND MainGroup='ACCOUNTS INTEGRATION'"
                str(1) = "DELETE FROM MASTER..USERADMIN WHERE  UserName='" & Trim(Me.txtusername.Text) & "' And MainGroup='ACCOUNTS INTEGRATION'"
                str.Copy(qry, 0, str, 2, qry.Length)
                gconnection.MoreTransold(str)
                Call ClearOperation()
                Exit Sub
            End If
        End If
        ...
        If Me.OptCP.Checked = True Then
            ReDim qry(1)
            If Trim(Me.txtusername.Text) <> "" Then
                qry(0) = "UPDATE USERADMIN SET userpassword='" & Trim(abcdADD(Me.txtPassword.Text)) & "' where UserName='" & Trim(Me.txtusername.Text) & "' And MainGroup='ACCOUNTS INTEGRATION' "
                qry(1) = "UUPDATE MASTER..USERADMIN SET userpassword='" & Trim(abcdADD(Me.txtPassword.Text)) & "' where UserName='" & Trim(Me.txtusername.Text) & "' AND And MainGroup='ACCOUNTS INTEGRATION' "
                gconnection.MoreTransold(qry)
                Call ClearOperation()
                Exit Sub
            Else
    ...
    Sub getusers()
        ...
        Sqlstring = "SELECT DISTINCT ISNULL(USERNAME,'') AS USERNAME FROM USERADMIN WHERE ISNULL(CATEGORY,'') <> 'S' AND MAINGROUP = 'ACCOUNTS INTEGRATION'"
        gconnection.getDataSet(Sqlstring, "USER")
        If gdataset.Tables("USER").Rows.Count > 0 Then
    ...
    Private Sub lstUsers_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstUsers.Click
        ...
        Try
            If Me.lstUsers.Items.Count > 0 Then
                Sqlstring = "SELECT * FROM USERADMIN WHERE USERNAME = '" & Me.lstUsers.Items.Item(lstUsers.SelectedIndex) & "' AND MAINGROUP = 'ACCOUNTS INTEGRATION' "
                gconnection.getDataSet(Sqlstring, "USER")
                If gdataset.Tables("USER").Rows.Count > 0 Then
    ...
    Sub UserDetails(ByVal UserName As String)
        ...
        Dim vmain As Double
        Sqlstring = "SELECT ISNULL(MODULENAME,0) AS MODULENAME,ISNULL(RIGHTS,'') AS RIGHTS FROM USERADMIN WHERE USERNAME = '" & Trim(UserName) & "' AND MAINGROUP = 'ACCOUNTS INTEGRATION' "
        gconnection.getDataSet(Sqlstring, "USER")
        If gdataset.Tables("USER").Rows.Count > 0 Then
