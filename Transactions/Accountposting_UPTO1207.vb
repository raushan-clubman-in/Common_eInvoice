...
#End Region
    ...
    Private Sub Cmd_Posted_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Posted.Click
        ...
        For K = 0 To 1
            If K = 0 Then
                ...
                'shan
                '03/05/2008
                '                SQLSTRING = "EXEC Cp_AccountsPostingView_New " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'T'"
                SQLSTRING = "EXEC Cp_AccountsPostingView_New " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "'"
            ...
            SQLSTRING = "EXEC Cp_PosJv '" & Mid(Trim(gFinancalyearStart), 3, 4) & "','" & Mid(Trim(gFinancialYearEnd), 3, 4) & "','" & Trim(gUsername) & "','" & Format(Now, "dd-MMM-yyyy") & "'"
            gconnection.dataOperation(6, SQLSTRING, "ACCOUNTPOSTING")
            'End
    ...
    Private Sub Fillaccountpostingdetails()
        ...
        Try
            ...
            For j = 0 To 1
                If j = 0 Then
                    '03/05/2008
                    '                    strsql = "Exec Cp_AccountsPostingView_New " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'T'"
                    strsql = "Exec Cp_AccountsPostingView_New " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "'"
                    strPostHead = "Posted Accounts"
                Else
                    'strsql = "Exec Cp_AccountsPostingView_New " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "', 'P'"
                    strsql = "Exec Cp_AccountsPostingView_New " & "'" & Format(dtp_Fromdate.Value, "dd-MMM-yyyy") & "','" & Format(dtp_Todate.Value, "dd-MMM-yyyy") & "'"
    ...
    Private Sub GetRights()
        ...
        Dim chstr As String
        SQLSTRING = "SELECT * FROM useradmin WHERE USERNAME = '" & Trim(gUsername) & "' AND MAINGROUP='POS' AND MODULENAME LIKE '" & Trim(GmoduleName) & "%' ORDER BY RIGHTS"
    ...
    Private Sub cmdPost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPost.Click
        ...
        Try
            ...
            '03/05/2008
            'strsql = "EXEC Cp_PosJv '" & Mid(Trim(gFinancalyearStart), 3, 4) & "','" & Mid(Trim(gFinancialYearEnd), 3, 4) & "','" & Trim(gUsername) & "','" & Format(Now, "dd-MMM-yyyy") & "', 'P'"
            strsql = "EXEC Cp_PosJv '" & Mid(Trim(gFinancalyearStart), 3, 4) & "','" & Mid(Trim(gFinancialYearEnd), 3, 4) & "','" & Trim(gUsername) & "','" & Format(Now, "dd-MMM-yyyy") & "'"
            'End
            gconnection.dataOperation(6, strsql, "ACCOUNTPOSTING")
    ...
    Private Sub Accountpostingssgrid_Advance(ByVal sender As System.Object, ByVal e As AxFPSpreadADO._DSpreadEvents_AdvanceEvent) Handles Accountpostingssgrid.Advance
