...
Public Class SaleRegisterDatewise
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SaleRegisterDatewise.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSTINTEGRATION.SaleRegisterDatewise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleRegisterDatewise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleRegisterDatewise = New SaleRegisterDatewise()
        rpt.Site = Me.Site
        Return rpt
    End Function
