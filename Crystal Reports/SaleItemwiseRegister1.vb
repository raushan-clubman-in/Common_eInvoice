...
Public Class SaleItemwiseRegister1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SaleItemwiseRegister1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSTINTEGRATION.SaleItemwiseRegister1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_posdesc() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSaleItemwiseRegister1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleItemwiseRegister1 = New SaleItemwiseRegister1()
        rpt.Site = Me.Site
        Return rpt
    End Function
