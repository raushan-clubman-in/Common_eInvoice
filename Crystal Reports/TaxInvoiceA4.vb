...
Public Class TaxInvoiceA4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GSTINTEGRATION.TaxInvoiceA4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTaxInvoiceA4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TaxInvoiceA4 = New TaxInvoiceA4()
        rpt.Site = Me.Site
        Return rpt
    End Function
