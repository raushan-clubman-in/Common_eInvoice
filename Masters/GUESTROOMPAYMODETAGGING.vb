Public Class GUESTROOMPAYMODETAGGING
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(GUESTROOMPAYMODETAGGING))
        ...
        Me.ssgrid1.Location = New System.Drawing.Point(96, 32)
        ...
        Me.Name = "GUESTROOMPAYMODETAGGING"
        Me.Text = "GUESTROOMPAYMODETAGGING"
...
#End Region
    ...
    Private Sub GUESTROOMPAYMODETAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "SELECT CHARGETYPE,ISNULL(LEDGERNAME,'')AS LEDGERNAME,ISNULL(costcenter,'')AS costcenter FROM RoomAccountPostingSetupMaster a   order by a.CHARGETYPE "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    .Row = j
                    .Col = 1
                    .Text = gdataset.Tables("acctag").Rows(i).Item("CHARGETYPE")
                    .Col = 2
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.GUESTROOMPAYMODETAGGING_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update RoomAccountPostingSetupMaster set LEDGERNAME='" & acccd & "',costcenter='" & cc & "' where CHARGETYPE='" & itemcd & "'"
