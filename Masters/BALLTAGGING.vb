...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(BALLTAGGING))
        ...
        Me.Label1.Text = "GOLF BALL TAGGING"
        '
        'BALLTAGGING
        '
...
#End Region
    ...
    Private Sub BALLTAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.UOM,'GOLF BALL ' AS CAT_DESCRIPTION ,isnull(a.TAXTYPE,'') as LedgerName,isnull(a.SACNO,'') as costcenter  from GMS_BALLRATEMASTER a   order by a.UOM "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    .Row = j
                    .Col = 1
                    .Text = gdataset.Tables("acctag").Rows(i).Item("UOM")
                    .Col = 2
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.BALLTAGGING_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update GMS_BALLRATEMASTER set TAXTYPE='" & acccd & "',SACNO='" & cc & "' where UOM='" & itemcd & "'"
