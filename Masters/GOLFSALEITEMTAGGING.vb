Public Class GOLFSALEITEMTAGGING
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(GOLFSALEITEMTAGGING))
        ...
        Me.Label1.Text = "GOLF HIRING TAGGING"
        '
        'GOLFSALEITEMTAGGING
        '
        ...
        Me.Name = "GOLFSALEITEMTAGGING"
        Me.Text = "GOLFSALEITEMTAGGING"
...
#End Region
    ...
    Private Sub GOLFSALEITEMTAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.ITEMCODE,a.ITEMDESC ,isnull(a.TAXTYPE,'') as LedgerName,isnull(a.SACNO,'') as costcenter  from GMS_SALEITEMMASTER a   order by a.ITEMCODE "
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.GOLFSALEITEMTAGGING_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update GMS_SALEITEMMASTER set TAXTYPE='" & acccd & "',SACNO='" & cc & "' where ITEMCODE='" & itemcd & "'"
