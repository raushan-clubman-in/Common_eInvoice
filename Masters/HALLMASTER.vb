...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(HALLLEDGER))
        ...
        Me.Panel1.Location = New System.Drawing.Point(868, 136)
        ...
        Me.Label1.Text = "PARTY HALL LEDGER TAGGING"
        '
        'HALLLEDGER
        '
...
#End Region
    ...
    Private Sub HALLLEDGER_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select HALLTYPECODE,HALLTYPEDESC  ,isnull(a.TAXTYPE,'') as LedgerName,ISNULL(SACNO,'')AS SACNO  from party_hallmaster_HDR  a   order by a.HALLTYPEDESC "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    .Row = j
                    .Col = 1
                    .Text = gdataset.Tables("acctag").Rows(i).Item("HALLTYPECODE")
                    .Col = 2
                    .Text = gdataset.Tables("acctag").Rows(i).Item("HALLTYPEDESC")
                    .Col = 3
                    .Text = gdataset.Tables("acctag").Rows(i).Item("LedgerName")
                    .Col = 4
                    .Text = gdataset.Tables("acctag").Rows(i).Item("SACNO")
    ...
    Private Sub FillMenu()
        ...
        Dim ssql As String
        gSQLString = "select  LEDGERNAME from party_hallmaster_HDR "
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.HALLLEDGER_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update party_hallmaster_HDR set TAXTYPE='" & acccd & "',SACNO='" & VoucherType & "' where HALLTYPECODE='" & itemcd & "'"
