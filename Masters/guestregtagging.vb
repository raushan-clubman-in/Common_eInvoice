...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(guestregtagging))
        ...
        Me.cmd_view.Location = New System.Drawing.Point(8, 72)
        ...
        Me.cmd_update.Location = New System.Drawing.Point(8, 128)
        ...
        Me.Label1.Text = "GUEST ENTRY TAGGING "
        '
        'guestregtagging
        '
...
#End Region
    ...
    Private Sub guestregtagging_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.loccode,a.locdesc ,isnull(a.TAXTYPE,'') as LedgerName,isnull(a.SACNO,'') as costcenter  from gr_locationmaster a   order by a.loccode "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    .Row = j
                    .Col = 1
                    .Text = gdataset.Tables("acctag").Rows(i).Item("loccode")
                    .Col = 2
                    .Text = gdataset.Tables("acctag").Rows(i).Item("locdesc")
                    .Col = 3
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.guestregtagging_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update gr_locationmaster set TAXTYPE='" & acccd & "',SACNO='" & cc & "' where loccode='" & itemcd & "'"
