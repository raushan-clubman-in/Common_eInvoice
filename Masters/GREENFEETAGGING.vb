...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(GREENFEETAGGING))
        ...
        Me.Panel1.Location = New System.Drawing.Point(864, 144)
        ...
        Me.Label1.Text = "GREEN FEE TAGGING"
        '
        'GREENFEETAGGING
        '
        ...
        Me.Name = "GREENFEETAGGING"
        Me.Text = "GREENFEETAGGING"
...
#End Region
    ...
    Private Sub GREENFEETAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.CATEGORYCODE,a.CAT_DESCRIPTION ,isnull(a.TAXTYPE,'') as LedgerName,isnull(a.SACNO,'') as costcenter  from GMS_GREENFEEMASTER a   order by a.CATEGORYCODE "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    .Row = j
                    .Col = 1
                    .Text = gdataset.Tables("acctag").Rows(i).Item("CATEGORYCODE")
                    .Col = 2
                    .Text = gdataset.Tables("acctag").Rows(i).Item("CAT_DESCRIPTION")
                    .Col = 3
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.GREENFEETAGGING_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update GMS_GREENFEEMASTER set TAXTYPE='" & acccd & "',SACNO='" & cc & "' where categorycode='" & itemcd & "'"
