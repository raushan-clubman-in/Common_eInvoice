Public Class SUBPAYMENTTAGGING
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(SUBPAYMENTTAGGING))
        ...
        Me.Panel1.Location = New System.Drawing.Point(172, 504)
        ...
        Me.Name = "SUBPAYMENTTAGGING"
        Me.Text = "SUBPAYMENTTAGGING"
...
#End Region
    ...
    Private Sub SUBPAYMENTTAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "SELECT Subpaymentcode,Subpaymentname,ISNULL(LEDGERNAME,'')AS LEDGERNAME,ISNULL(COSTCENTERCODE,'')AS COSTCENTERCODE,ISNULL(creditbarledgername,'')AS creditbarledgername,ISNULL(creditcateringledgername,'')AS creditcateringledgername,ISNULL(creditbarcostcenter,'')AS creditbarcostcenter,ISNULL(creditcatcostcenter,'')AS creditcatcostcenter,ISNULL(cl_cost_per,0)AS cl_cost_per,ISNULL(golfcreditbarledgername,'')AS golfcreditbarledgername,ISNULL(golfcreditcateringledgername,'')AS golfcreditcateringledgername,ISNULL(golfcreditbarcostcenter,'')AS golfcreditbarcostcenter,ISNULL(golfcreditcateringcostcenter,'')AS  golfcreditcateringcostcenter FROM SUBPAYMENTMODE   order by Subpaymentcode "
        Vconn.getDataSet(SQLSTRING, "acctag")
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For j = 0 To gdataset.Tables("acctag").Columns.Count - 1
                With ssgrid1
                    .Row = 1
                    .Col = j + 1
                    .FontBold = True
                    .ForeColor = Color.Blue
                    .Text = UCase(gdataset.Tables("acctag").Columns(j).ColumnName)
                End With
            Next
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                For j = 0 To gdataset.Tables("acctag").Columns.Count - 1
                    With ssgrid1
                        .Row = i + 2
                        .Col = j + 1
                        .Text = gdataset.Tables("acctag").Rows(i).Item(j)
                        '.Col = 2
                        '.Text = gdataset.Tables("acctag").Rows(i).Item("CAMPNAME")
                        '.Col = 3
    ...
    Private Sub FillMenu()
        ...
        Dim ssql As String
        gSQLString = "select  LEDGERNAME from ACCOUNTSSUBLEDGERMASTER "
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.SUBPAYMENTTAGGING_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        Dim i, cl_cost_per As Integer
        Dim itemcd, acccd, ssql, cc, creditbarledgername, creditcateringledgername, creditbarcostcenter, creditcatcostcenter, golfcreditbarledgername, golfcreditcateringledgername, golfcreditbarcostcenter, golfcreditcateringcostcenter As String
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                cc = .Text
                .Col = 5
                creditbarledgername = .Text
                .Col = 6
                creditcateringledgername = .Text
                .Col = 7
                creditbarcostcenter = .Text
                .Col = 8
                creditcatcostcenter = .Text
                .Col = 9
                cl_cost_per = Val(.Text)
                .Col = 10
                golfcreditbarledgername = .Text
                .Col = 11
                golfcreditcateringledgername = .Text
                .Col = 12
                golfcreditbarcostcenter = .Text
                .Col = 13
                golfcreditcateringcostcenter = .Text
                ssql = "update SUBPAYMENTMODE set LEDGERNAME='" & acccd & "',COSTCENTERCODE='" & cc & "' ,creditbarledgername ='" & creditbarledgername & "',creditcateringledgername='" & creditcateringledgername & "',creditbarcostcenter='" & creditbarcostcenter & "',creditcatcostcenter='" & creditcatcostcenter & "',cl_cost_per='" & cl_cost_per & "',golfcreditbarledgername='" & golfcreditbarledgername & "',golfcreditcateringledgername='" & golfcreditcateringledgername & "',golfcreditbarcostcenter='" & golfcreditbarcostcenter & "',golfcreditcateringcostcenter='" & golfcreditcateringcostcenter & "' where Subpaymentcode='" & itemcd & "'"
