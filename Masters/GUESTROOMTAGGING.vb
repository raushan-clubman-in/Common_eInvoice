...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(GUESTROOMTAGGING))
        ...
        Me.Name = "GUESTROOMTAGGING"
        Me.Text = "GUESTROOMTAGGING"
...
#End Region
    ...
    Private Sub GUESTROOMTAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "SELECT A.TYPECODE,A.TYPEDESC,A.DRCR,ISNULL(A.TAXTYPE,'')AS LEDGERNAME,ISNULL(A.SACNO,'')AS costcenter FROM ROOM_Accounts_SETUP a   order by a.TYPECODE "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    .Row = j
                    .Col = 1
                    .Text = gdataset.Tables("acctag").Rows(i).Item("TYPECODE")
                    .Col = 2
                    .Text = gdataset.Tables("acctag").Rows(i).Item("TYPEDESC")
                    .Col = 3
                    .Text = gdataset.Tables("acctag").Rows(i).Item("DRCR")
                    .Col = 4
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.GUESTROOMTAGGING_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        Dim i As Integer
        Dim itemcd, acccd, ssql, cc, DRCR As String
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update ROOM_Accounts_SETUP set TAXTYPE='" & acccd & "',SACNO='" & cc & "' where TYPECODE='" & itemcd & "' AND DRCR='" & DRCR & "'"
