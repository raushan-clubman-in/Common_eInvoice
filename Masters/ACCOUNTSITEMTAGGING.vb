...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmd_exit.Location = New System.Drawing.Point(8, 248)
        ...
        Me.Panel1.Location = New System.Drawing.Point(864, 136)
        Me.Panel1.Name = "Panel1"
        Me.Panel1.Size = New System.Drawing.Size(144, 296)
        ...
        Me.cmd_export.Location = New System.Drawing.Point(8, 200)
        ...
        Me.Cmd_Audit.Location = New System.Drawing.Point(8, 152)
        ...
        Me.Label1.Text = "POS ITEM TAGGING"
        '
        'ACCOUNTSITEMTAGGING
        '
...
#End Region
    ...
    Private Sub ACCOUNTSITEMTAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.itemcode,a.itemdesc ,isnull(a.groupcode,'') as groupcode,isnull(c.groupdesc,'') +'--'+ isnull(itemtypecode,'') as groupdesc,isnull(a.TAXTYPE,'') as LedgerName,ISNULL(A.HSNNO,'')AS COSTCENTER  from itemmaster a  left outer join groupmaster c on a.groupcode=c.groupcode AND ISNULL(A.FREEZE,'')<>'Y' order by A.TAXTYPE,A.GROUPCODE,a.itemcode "
    ...
    Private Sub FillMenuCOST()
        ...
        Dim ssql As String
        gSQLString = "select DISTINCT HSNNO from ITEMMASTER "
        vform.Field = "HSNNO"
        vform.vFormatstring = "HSNNO"
        vform.vCaption = "HSNNO  HELP"
        vform.KeyPos = 0
        vform.KeyPos1 = 0
        vform.ShowDialog(Me)
    ...
    Private Sub FillMenu()
        Dim vform As New ListOperattion1
        Dim ssql As String
        gSQLString = "select DISTINCT TAXTYPE from ITEMMASTER "
        vform.Field = "TAXTYPE"
        vform.vFormatstring = "TAXTYPE"
        vform.vCaption = "TAX TYPE  HELP"
        vform.KeyPos = 0
        vform.KeyPos1 = 0
        vform.ShowDialog(Me)
        If Trim(vform.keyfield & "") <> "" Then
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update itemmaster set TAXTYPE='" & acccd & "',GROUPCODE='" & groupcd & "',HSNNO='" & COSTCD & "' where itemcode='" & itemcd & "'"
