...
#End Region
    ...
    Private Sub TARIFFTAGGING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.CAMPCODE,a.CAMPNAME ,isnull(a.LEDGERNAME,'') as LedgerName,isnull(a.costcenter,'') as costcenter  from GMS_CAMPMASTER a   order by a.CAMPCODE "
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                ssql = "update GMS_CAMPMASTER set LEDGERNAME='" & acccd & "',costcenter='" & cc & "' where CAMPCODE='" & itemcd & "'"
