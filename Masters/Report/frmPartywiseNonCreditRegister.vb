...
Public Class NonCreditRegister
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(NonCreditRegister))
        ...
        Me.lbl_Heading.Size = New System.Drawing.Size(423, 25)
        Me.lbl_Heading.TabIndex = 9
        Me.lbl_Heading.Text = "NON CREDIT REGISTER [LOCATION WISE ]"
        '
        'CmdClear
        '
        ...
        Me.CmdClear.Location = New System.Drawing.Point(256, 616)
        ...
        Me.CmdPrint.Location = New System.Drawing.Point(576, 616)
        ...
        Me.cmdexit.Location = New System.Drawing.Point(744, 616)
        ...
        Me.GroupBox3.Location = New System.Drawing.Point(200, 536)
        ...
        Me.CmdView.Location = New System.Drawing.Point(416, 616)
        ...
        Me.GroupBox4.Location = New System.Drawing.Point(200, 600)
        ...
        Me.grp_SalebillChecklist.Location = New System.Drawing.Point(140, 1000)
        Me.grp_SalebillChecklist.Name = "grp_SalebillChecklist"
        Me.grp_SalebillChecklist.Size = New System.Drawing.Size(712, 64)
        Me.grp_SalebillChecklist.TabIndex = 421
        ...
        Me.Chklist_membername.Location = New System.Drawing.Point(160, 104)
        ...
        Me.Chk_Selectmembername.Location = New System.Drawing.Point(163, 56)
        Me.Chk_Selectmembername.Name = "Chk_Selectmembername"
        Me.Chk_Selectmembername.Size = New System.Drawing.Size(128, 24)
        Me.Chk_Selectmembername.TabIndex = 0
        ...
        Me.Label5.Location = New System.Drawing.Point(200, 656)
        ...
        Me.Label3.Location = New System.Drawing.Point(608, 80)
        ...
        Me.ClientSize = New System.Drawing.Size(992, 700)
        ...
        Me.KeyPreview = True
        Me.Name = "NonCreditRegister"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "NON CREDIT REGISTER [ PARTY WISE ]"
...
#End Region
    ...
    Private Sub ViewPartyWiseNonCreditRegister()
        Dim MemberCode(), SQLSTRING2 As String
        Dim i As Integer
        Try
            Dim sqlstring = "SELECT * FROM VIEWNONCREDITPARTYWISE"
            If Chklist_membername.CheckedItems.Count <> 0 Then
            ...
            End If
            'Begin
            'sqlstring = sqlstring & " AND PAYMENTMODE = 'N.CREDIT' AND CAST(Convert(varchar(11),BILLDATE,6) AS DATETIME) BETWEEN "
            ...
            sqlstring = sqlstring & " ORDER BY MCODE,POSDESC, BILLDATE,BILLDETAILS,MNAME"
            ''document count===============================
            SQLSTRING2 = "SELECT COUNT(A.BILLDETAILS),A.MCODE,A.MNAME FROM (  "
            SQLSTRING2 = SQLSTRING2 & " select billdetails,mcode,mname from VIEWNONCREDITPARTYWISE"
            If Chklist_membername.CheckedItems.Count <> 0 Then
            ...
            End If
            If Chklist_POSLocation.CheckedItems.Count <> 0 Then
                SQLSTRING2 = SQLSTRING2 & " AND POSDESC IN ("
                For i = 0 To Chklist_POSLocation.CheckedItems.Count - 1
                    SQLSTRING2 = SQLSTRING2 & "'" & Chklist_POSLocation.CheckedItems(i) & "', "
                Next
                SQLSTRING2 = Mid(SQLSTRING2, 1, Len(SQLSTRING2) - 2)
                SQLSTRING2 = SQLSTRING2 & ")"
            Else
            ...
            SQLSTRING2 = SQLSTRING2 & " group by mcode,mname,BILLDETAILS) A "

            SQLSTRING2 = SQLSTRING2 & " GROUP by A.mcode,A.MNAME ORDER BY A.MCODE"

            ''=============================================
            Dim pageheading() As String = {"NON CREDIT SALES REGISTER"}
            Dim objPartywiseNonCreditRegisterReport As New rptPartywiseNonCreditRegisterReport
            objPartywiseNonCreditRegisterReport.ReportDetails(sqlstring, SQLSTRING2, pageheading, mskFromDate.Value, mskToDate.Value)
        Catch ex As Exception
    ...
    Private Sub Timer1_Tick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        Try
            ...
            Else
                ...
                Call ViewPartyWiseNonCreditRegister()
            End If
        Catch ex As Exception
            MessageBox.Show("Check The Error " & ex.Message, MyCompanyName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
            Exit Sub
    ...
    Private Sub NonCreditRegister_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
            Dim i As Integer
