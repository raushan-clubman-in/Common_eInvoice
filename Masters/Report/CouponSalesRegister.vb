...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Chk_SelectAllPos.TabIndex = 372
        ...
        Me.frmbut.Location = New System.Drawing.Point(152, 272)
        Me.frmbut.Name = "frmbut"
        Me.frmbut.Size = New System.Drawing.Size(480, 54)
        Me.frmbut.TabIndex = 371
        ...
        Me.mskToDate.Location = New System.Drawing.Point(516, 232)
        ...
        Me.Label5.Location = New System.Drawing.Point(404, 232)
        ...
        Me.mskFromDate.Location = New System.Drawing.Point(240, 232)
        ...
        Me.Label2.Location = New System.Drawing.Point(136, 232)
        ...
        Me.LstPOS.Size = New System.Drawing.Size(224, 154)
        Me.LstPOS.TabIndex = 363
        '
        'Label4
        '
        ...
        'LstServer
        '
        Me.LstServer.Location = New System.Drawing.Point(432, 32)
        Me.LstServer.Name = "LstServer"
        Me.LstServer.Size = New System.Drawing.Size(224, 154)
        Me.LstServer.TabIndex = 364
        '
        'GroupBox1
        '
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(560, 56)
...
#End Region
    ...
    Private Sub CmdView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdView.Click
        ...
        Dim sqlstring = "select dbo.POSMaster.POSDesc, dbo.Bill_Hdr.BillDate,dbo.Bill_Hdr.BillDetails,ISNULL(dbo.bill_det.kotamount,0) AS KOTAMOUNT,"
        sqlstring = sqlstring & "  ISNULL(bill_det.taxamount,0) AS TAXAMOUNT, ISNULL(totalamt,0) AS TOTALAMT,SERVERMASTER.SERVERNAME from dbo.Bill_Hdr "
        ...
        sqlstring = sqlstring & "  INNER JOIN SERVERMASTER ON SERVERMASTER.SERVERCODE=KOT_DET.SCODE  "
        sqlstring = sqlstring & "  where dbo.bill_hdr.paymentmode='COUPON SALE'"

        If LstPOS.CheckedItems.Count <> 0 Then
            sqlstring = sqlstring & " and dbo.posmaster.posdesc in ("
        ...
        Dim columnheading() As String = {"Bill Date", "Bill No", "Basic", "Sales Tax", "Ser Charge", "Net Amount", "Server"}
        Dim pageheading() As String = {"COUPON SALES REGISTER "}
        Dim colsize() As Integer = {12, 18, 20, 20, 20, 20, 20}
        Dim total() As Integer = {2, 3, 5}
        Dim CouponSalesRegisterReport As New CouponSalesRegisterReport
        CouponSalesRegisterReport.begin()
        CouponSalesRegisterReport.buttonclick(vconn.sqlconnection, sqlstring, pageheading, columnheading, colsize, LstPOS, mskFromDate.Value, mskToDate.Value, total)
    End Sub
