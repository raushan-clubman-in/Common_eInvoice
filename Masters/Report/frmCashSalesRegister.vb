...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "CASH SALE REGISTER "
        '
        'Chk_Servercode
        '
        ...
        Me.CheckBox1.Location = New System.Drawing.Point(128, 520)
        ...
        Me.CheckBox2.Location = New System.Drawing.Point(232, 520)
...
#End Region
    ...
    Public Sub viewCashSaleregister()
        Try
            ...
            Dim sqlstring = "SELECT DISTINCT BILLNO,BILLDATE,BILLAMOUNT,TAXAMOUNT,TOTALAMOUNT,PAIDAMOUNT,RECEIPTDETAILS,BALANCEAMT,RECEIPTDATE,SCODE,posdesc,POSCODE FROM VIEWCASHSALEREGISTER"
            If Chklist_POSLocation.CheckedItems.Count <> 0 Then
            ...
            Dim ObjCashSalesRegisterReport As New CashSalesRegisterReport
