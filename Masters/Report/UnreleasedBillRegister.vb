...
#End Region
    ...
    Private Sub CmdView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdView.Click
        ...
        Dim columnheading() As String = {"Location/Server", "Bill Date", "Bill No", "Mode", "Code", "Net Amt"}
        ...
        UnreleasedBillRegisterReport.begin()
        UnreleasedBillRegisterReport.buttonclick(vconn.sqlconnection, sqlstring, pageheading, columnheading, colsize, LstPOS, mskFromDate.Value, mskToDate.Value, total)
    End Sub
