Public Class VENDORLEDGERsubledger
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(VENDORLEDGERsubledger))
        ...
        Me.Panel1.Location = New System.Drawing.Point(868, 176)
        ...
        Me.ssgrid1.Size = New System.Drawing.Size(664, 376)
        ...
        Me.Label1.Text = "ACCOUNTS DEBTORS LEDGER "
        '
        'Label2
        '
...
#End Region
    ...
    Private Sub VENDORLEDGERsubledger_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select A.ACCODE,ISNULL(A.ACDESC,'')AS ACDESC,a.SLCODE,a.SLDESC ,ISNULL(GSTINNO,'')AS GSTINNO  from ACCOUNTSSUBLEDGERMASTER a  WHERE  ISNULL(ACCODE,'')<>'' AND SLTYPE IN('MEMBER','OTHERS','DEBTORS','OTHER')AND ACCODE NOT IN(SELECT ISNULL(SCRSCODE,'') FROM ACCOUNTSSETUP UNION ALL SELECT ISNULL(SDRSCODE,'') FROM ACCOUNTSSETUP ) AND ISNULL(FREEZEFLAG,'')<>'Y' order by A.ACCODE,a.SLCODE "
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.VENDORLEDGERsubledger_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        ...
        With ssgrid1
            ...
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                VoucherType = .Text
                If VoucherType <> "" Then
                    ssql = "update ACCOUNTSSUBLEDGERMASTER set GSTINNO='" & VoucherType & "' where ACCODE='" & itemcd & "' AND SLCODE='" & acccd & "'"
                    Vconn.dataOperation(6, ssql, "item")
                End If
            Next
