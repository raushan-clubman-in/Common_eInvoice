...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(VENDORLEDGER))
        ...
        Me.Label1.Text = "ACCOUNTS VENDOR LEDGER "
        '
        'Label2
        '
...
#End Region
    ...
    Private Sub VENDORLEDGER_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i, j As Integer
        SQLSTRING = "select a.SLCODE,a.SLDESC ,isnull(sltype,'') as sltype,isnull(a.VENDORTYPE,'') as LedgerName,ISNULL(GSTINNO,'')AS GSTINNO  from ACCOUNTSSUBLEDGERMASTER a  WHERE ACCODE IN(SELECT ISNULL(SCRSCODE,'') FROM ACCOUNTSSETUP)AND ISNULL(FREEZEFLAG,'')<>'Y'  order by a.SLCODE "
        ...
        If gdataset.Tables("acctag").Rows.Count > 0 Then
            For i = 0 To gdataset.Tables("acctag").Rows.Count - 1
                ...
                With ssgrid1
                    ...
                    .Col = 3
                    .Text = gdataset.Tables("acctag").Rows(i).Item("sltype")
                    .Col = 4
    ...
    Private Sub cmd_clear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_clear.Click
        ...
        Call Me.VENDORLEDGER_Load(sender, e)
    End Sub
    ...
    Private Sub cmd_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_update.Click
        Dim i As Integer
        Dim itemcd, acccd, ssql, VoucherType, sltype As String
        ...
        With ssgrid1
            ...
            For i = 0 To ssgrid1.DataRowCnt - 1
                ...
                VoucherType = .Text
                If VoucherType <> "" Then
                    ssql = "update ACCOUNTSSUBLEDGERMASTER set VENDORTYPE='" & acccd & "',GSTINNO='" & VoucherType & "' where SLCODE='" & itemcd & "' and sltype='" & sltype & "'"
                    Vconn.dataOperation(6, ssql, "item")
                End If
            Next
